...
namespace OpenForum.UnitTests.Controllers
{
    ...
    public class ForumControllerTests
    {
        ...
        {            
            ...
            postRepository.Expect(x => x.Find()).Returns(posts.AsQueryable());
        ...
        public void View_Correct_Post_For_View_Page()
        {
            Post post = new Post();
            Mock<IPostRepository> postRepository = new Mock<IPostRepository>();
            postRepository.Expect(x => x.FindById(1)).Returns(post);
        ...
        {
            Mock<IPostRepository> postRepository = new Mock<IPostRepository>();
            postRepository.Expect(x => x.FindById(1)).Returns<Post>(null);
            ...
            {
                Assert.AreEqual("The request forum post could not be found. (Post id = 1)", exception.Message);
            }
        }
        ...
        public void View_Create_Response_Post_Page()
        {
            ...
            Assert.AreEqual("", result.ViewName);
            Assert.AreEqual(1, resultViewData.Reply.PostId);
        ...
        {
            Mock<IPostRepository> postRepository = new Mock<IPostRepository>();
            postRepository.Expect(x => x.Submit(It.IsAny<Post>())).AtMostOnce().Verifiable();
        ...
        public void Save_New_Reply()
        {
            ...
            Mock<IPostRepository> postRepository = new Mock<IPostRepository>();
            postRepository.Expect(x => x.FindById(1)).Returns(post).Verifiable();
            postRepository.Expect(x => x.Submit(post)).AtMostOnce().Verifiable();
            ...
            Assert.AreEqual("body", post.Replies[0].Body);
            postRepository.VerifyAll();
        }
        ...
        public void Save_Existing_Post()
        {
            ...
            Mock<IPostRepository> postRepository = new Mock<IPostRepository>();
            postRepository.Expect(x => x.FindById(1)).Returns(post).Verifiable();
            postRepository.Expect(x => x.Submit(post)).Verifiable();
        ...
        public void Request_Image()
        {
            ...
            Assert.AreEqual(3351, result.FileContents.Length);
        }
        ...
        public void Search_Returns_The_Correct_Posts()
        {
            ...
            Mock<IPostRepository> postRepository = new Mock<IPostRepository>();
            postRepository.Expect(x => x.Search("test")).Returns(posts.AsQueryable());
        ...
        {
            Mock<IPostRepository> postRepository = new Mock<IPostRepository>();
            postRepository.Expect(x => x.Find()).Returns(new List<Post>().AsQueryable());
        ...
        {
            Mock<IPostRepository> postRepository = new Mock<IPostRepository>();
            postRepository.Expect(x => x.Search("test")).Returns(new List<Post>().AsQueryable());
